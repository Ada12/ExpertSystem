 ...
 */
@Entity
@Table(name = "disc_rotor", schema = "expert_system", catalog = "")
public class DiscRotorEntity {
    private int id;
    private String discRId;
    ...
    @Basic
    @Column(name = "discR_ID")
    public String getDiscRId() {
        return discRId;
    }

    public void setDiscRId(String discRId) {
    ...
    public boolean equals(Object o) {
        ...
        DiscRotorEntity that = (DiscRotorEntity) o;

        if (id != that.id) return false;
        if (discRId != null ? !discRId.equals(that.discRId) : that.discRId != null) return false;
    ...
    public int hashCode() {
        int result = id;
        result = 31 * result + (discRId != null ? discRId.hashCode() : 0);
