...
public class BasicVentedRotorEntity {
    ...
    private String rtCkIn;
    private String rtCkOut;
    private Double rtT;
    private Integer rtVanNum;
    private Double rtVanLen;
    private Double rtVaneHigh;
    private Double rtVanT;
    private Double rtWm;
    private Double rtWa;
    private Double rho;
    private Double cc50;
    ...
    @Basic
    @Column(name = "rt_ck_in")
    public String getRtCkIn() {
        return rtCkIn;
    }

    public void setRtCkIn(String rtCkIn) {
        this.rtCkIn = rtCkIn;
    }

    @Basic
    @Column(name = "rt_ck_out")
    public String getRtCkOut() {
        return rtCkOut;
    }

    public void setRtCkOut(String rtCkOut) {
        this.rtCkOut = rtCkOut;
    }
    ...
    @Basic
    @Column(name = "rt_van_num")
    public Integer getRtVanNum() {
        return rtVanNum;
    }

    public void setRtVanNum(Integer rtVanNum) {
        this.rtVanNum = rtVanNum;
    }

    @Basic
    @Column(name = "rt_van_len")
    public Double getRtVanLen() {
        return rtVanLen;
    }

    public void setRtVanLen(Double rtVanLen) {
        this.rtVanLen = rtVanLen;
    }
    ...
    @Basic
    @Column(name = "rt_van_t")
    public Double getRtVanT() {
        return rtVanT;
    }

    public void setRtVanT(Double rtVanT) {
        this.rtVanT = rtVanT;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (rtCkIn != null ? !rtCkIn.equals(that.rtCkIn) : that.rtCkIn != null) return false;
        if (rtCkOut != null ? !rtCkOut.equals(that.rtCkOut) : that.rtCkOut != null) return false;
        if (rtT != null ? !rtT.equals(that.rtT) : that.rtT != null) return false;
        if (rtVanNum != null ? !rtVanNum.equals(that.rtVanNum) : that.rtVanNum != null) return false;
        if (rtVanLen != null ? !rtVanLen.equals(that.rtVanLen) : that.rtVanLen != null) return false;
        if (rtVaneHigh != null ? !rtVaneHigh.equals(that.rtVaneHigh) : that.rtVaneHigh != null) return false;
        if (rtVanT != null ? !rtVanT.equals(that.rtVanT) : that.rtVanT != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (rtCkIn != null ? rtCkIn.hashCode() : 0);
        result = 31 * result + (rtCkOut != null ? rtCkOut.hashCode() : 0);
        result = 31 * result + (rtT != null ? rtT.hashCode() : 0);
        result = 31 * result + (rtVanNum != null ? rtVanNum.hashCode() : 0);
        result = 31 * result + (rtVanLen != null ? rtVanLen.hashCode() : 0);
        result = 31 * result + (rtVaneHigh != null ? rtVaneHigh.hashCode() : 0);
        result = 31 * result + (rtVanT != null ? rtVanT.hashCode() : 0);
